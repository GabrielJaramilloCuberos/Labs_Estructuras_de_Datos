...
Node::Node(int data) {
    ...
    color = RED; // Nuevo nodo siempre comienza como rojo
}
...
// Función auxiliar para realizar recorrido inorder
...
// Función auxiliar para realizar recorrido en nivel
...
// Inserción en BST y mantenimiento de propiedades del Árbol Rojo-Negro
...
// Corrección de violaciones tras la inserción en el Árbol Rojo-Negro
